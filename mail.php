 ...
 <body>
    ...
    <div class="row">-->
                        ...
                        <div class="grid-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="compose.html" class="btn btn-block new-msg" data-toggle="modal" data-target="#compose-modal"><i class="fa fa-pencil"></i>&nbsp;&nbsp;NEW MESSAGE</a>
                                ...
                                <div class="col-md-9">
                                        ...
                                        <div class="col-md-6 search-form">
                                            <form action="#" class="text-right">
                                                <div class="input-group">
                                                    ...
                                                    <button type="submit" name="search" class="btn_ btn-sm search search-btn"><i class="fa fa-search"></i></button></span>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr class="read">
                                                <td class="action"><div class="icheckbox_square-green" st<td class="action"><input type="checkbox" /></td>
            ...
            <span class="home-button" style="border: 1px solid black;margin-left: 20px; padding: 10px 20px;"><a class="border px-3 p-1 add-experience" style="text-decoration: none; color: black;" href="dashboard.html"><i class="fa fa-share-square-o"></i>&nbsp;Back home</a></span>
</div>
